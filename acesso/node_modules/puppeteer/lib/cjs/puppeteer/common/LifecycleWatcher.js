...
class LifecycleWatcher {
    constructor(frameManager, frame, waitUntil, timeout) {
        ...
        this._sameDocumentNavigationCompleteCallback = noop;
        this._sameDocumentNavigationPromise = new Promise((fulfill) => {
            this._sameDocumentNavigationCompleteCallback = fulfill;
        });
        this._lifecycleCallback = noop;
        this._lifecyclePromise = new Promise((fulfill) => {
            this._lifecycleCallback = fulfill;
        });
        this._newDocumentNavigationCompleteCallback = noop;
        this._newDocumentNavigationPromise = new Promise((fulfill) => {
            this._newDocumentNavigationCompleteCallback = fulfill;
        });
        this._terminationCallback = noop;
        ...
        this._eventListeners = [
            ...
            helper_js_1.helper.addEventListener(this._frameManager, FrameManager_js_1.FrameManagerEmittedEvents.FrameNavigated, this._navigated.bind(this)),
