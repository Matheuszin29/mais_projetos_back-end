...
export declare class HTTPResponse {
    ...
    export declare class LifecycleWatcher {
        ...
        _sameDocumentNavigationPromise: Promise<Error>;
        _lifecycleCallback: () => void;
        _lifecyclePromise: Promise<void>;
        _newDocumentNavigationCompleteCallback: (x?: Error) => void;
        _newDocumentNavigationPromise: Promise<Error | undefined>;
        _terminationCallback: (x?: Error) => void;
        _terminationPromise: Promise<Error | undefined>;
    ...
    export declare class NetworkManager extends EventEmitter {
        ...
        _handleRequestRedirect(request: HTTPRequest, responsePayload: Protocol.Network.Response, extraInfo: Protocol.Network.ResponseReceivedExtraInfoEvent | null): void;
